  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      ...
      <section
        ...
        className="keyline-border relative overflow-hidden rounded-2xl bg-primary p-6 shadow-[4px_4px_0_var(--color-ink)] sm:p-8"
      >
        ...
        <div className="relative">
          ...
          <h1
            ...
            className="font-display mt-3 text-3xl font-extrabold leading-tight text-ink sm:text-4xl"
            style={{ letterSpacing: '-0.5px' }}
          >
            Cuidemos juntos el agua de Morropón
          </h1>
          <p className="mt-3 max-w-prose font-body text-base leading-relaxed text-ink/90">
      ...
      <section aria-label="Tarjeta viva del Wasi">
        <button
          ...
          className="keyline-border group flex min-h-12 w-full flex-col rounded-2xl bg-gradient-to-br from-primary to-[#b8d4f0] p-5 text-left shadow-[4px_4px_0_var(--color-ink)] transition-transform hover:-translate-y-[1px] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
        >
          ...
          <div
            ...
            className="keyline-border mt-4 h-5 w-full overflow-hidden rounded-full bg-white/60"
          >
          ...
          <p className="mt-1 font-body text-xs font-bold text-ink/60 group-hover:text-ink">
      ...
      <section aria-labelledby="gallery-title" className="keyline-border rounded-2xl bg-white p-4 shadow-[4px_4px_0_var(--color-ink)]">
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3">
          {GALLERY_ITEMS.map((item) => (
            <figure key={item.title} className="overflow-hidden rounded-xl border-2 border-[#1c1c11] bg-bg-light shadow-[2px_2px_0_#1c1c11]">
