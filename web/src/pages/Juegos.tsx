  ...
  return (
    <div className="relative mx-auto max-w-[1000px] p-4 pb-24">
      ...
      <div className="mb-4 flex items-center justify-between gap-3 flex-wrap">
        <div>
          <h2 className="text-xl font-extrabold text-[#1c1c11]">🎮 Mini-juegos oficiales de Piura</h2>
          <p className="text-sm text-[#1c1c11]/70">Partidas reales de 60–90 s — gana 30 a 100 HydroPuntos solo con récord nuevo.</p>
        </div>
        <div className="flex items-center gap-2">
          <motion.div
            ...
            initial={{ scale: 0.96 }}
            animate={{ scale: 1 }}
            className="rounded-lg bg-white keyline px-3 py-2 text-sm font-extrabold shadow-[2px_2px_0_#1c1c11]"
          >
            ⚡ {hydro} HydroPuntos
          </motion.div>
          <Link
            to="/album"
            className="flex min-h-12 items-center gap-1 rounded-lg bg-[#FFB793] border-2 border-[#1c1c11] px-3 text-sm font-extrabold shadow-[2px_2px_0_#1c1c11]"
          >
            🏅 Álbum
          </Link>
        </div>
      ...
      <div className="mt-6 rounded-xl bg-[#FFB793] border-[3px] border-[#1c1c11] shadow-[6px_6px_0_#1c1c11] p-4">
        <h3 className="font-extrabold text-[#1c1c11]">ℹ️ Sobre los juegos</h3>
