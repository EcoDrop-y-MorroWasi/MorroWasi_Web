...
export default function Dashboard() {
  ...
  const reservoirPct = Math.round((mockReservoir.currentLiters / mockReservoir.capacityLiters) * 100)
    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-4">
      ...
      <section aria-label="Tarjeta viva del Wasi">
        ...
        >
          ...
          <p className="mt-1 font-body text-xs text-ink/60">{wasiVisual.scene}</p>
      ...
      >
        ...
        <dl className="mt-3 grid grid-cols-2 gap-2 font-body text-sm">
          <div className="keyline-border rounded-xl bg-bg-light p-3">
            ...
            <dd className="font-display text-base font-bold">{mockReservoir.capacityLiters} L</dd>
          </div>
          <div className="keyline-border rounded-xl bg-bg-light p-3">
            <dt className="text-xs font-bold text-ink/60">Nivel actual</dt>
            <dd className="font-display text-base font-bold">
              {mockReservoir.currentLiters} L
            </dd>
          </div>
          <div className="keyline-border rounded-xl bg-bg-light p-3">
