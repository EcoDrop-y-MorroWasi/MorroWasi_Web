      ...
      <div className="flex flex-1 flex-col gap-3 p-4 bg-bg-light/50">
        ...
        <div className="mt-auto flex gap-2">
          <motion.button
            ...
            onClick={onPlay}
            className="flex-1 min-h-[48px] rounded-lg bg-[#E26D5C] text-white border-2 border-ink font-extrabold shadow-[2px_2px_0_#1c1c11] active:shadow-none transition-all"
