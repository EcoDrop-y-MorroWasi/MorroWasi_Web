        ...
        >
          ...
          >
            ...
            <div
              ...
              className="keyline-border mt-3 h-4 w-full overflow-hidden rounded-full bg-surface"
            >
              <motion.div
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span
                        aria-hidden="true"
                        className={`keyline-border flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-base ${active ? 'bg-surface' : 'bg-bg-light'}`}
                      >
                        {visual.icon}
                      </span>
                      ...
                      {active && (
                        <span className="shrink-0 rounded-full bg-surface px-2 py-1 font-body text-xs font-bold text-accent">
                          Actual
                        </span>
                      )}
                      {achieved && !active && (
