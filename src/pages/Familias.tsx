    ...
    <div className="keyline-border rounded-2xl bg-bg-light p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {familiasOrdenadas.slice(0, 6).map((entry) => (
          <div
            ...
            className="keyline-border rounded-2xl bg-surface p-4"
      ...
      <section className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {litrosPorFamilia.map((item) => (
          <div key={item.label} className="keyline-border rounded-2xl bg-surface p-4">
      ...
      <section className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {progresoCursos.map((item) => (
          <div key={item.course} className="keyline-border rounded-2xl bg-surface p-4">
